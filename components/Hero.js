        ...
        <div className="min-w-[55%] max-w-[90%]">
          <div className="my-6 grid items-start gap-8">
            <div className="group relative rounded-xl border-4 border-primary-400">
              <Link href="/blog/reading">
                <a className="relative flex items-center justify-between rounded-lg bg-white px-7 py-4 leading-snug dark:bg-black">
                  ...
                  <span className="pl-6 text-primary-500 hover:text-primary-600 dark:hover:text-primary-400">
                    →
                  </span>
                </a>
              </Link>
            ...
            <div className="group relative rounded-xl border-4 border-indigo-400">
              <Link href="/blog">
                <a className="relative flex items-center justify-between rounded-lg bg-white px-7 py-4 leading-snug dark:bg-black">
                  ...
                  <span className="pl-6 text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400">
                    →
                  </span>
                </a>
              </Link>
            ...
            <div className="group relative rounded-xl border-4 border-green-400">
              <Link href={BLOG.githubLink}>
                <a className="relative flex items-center justify-between rounded-lg bg-white px-7 py-4 leading-snug dark:bg-black">
                  ...
                  <span className="pl-6 text-green-500 hover:text-green-600 dark:hover:text-green-400">
                    →
                  </span>
                </a>
              </Link>
